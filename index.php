      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-8 col-md-7 py-4">
            <h4 class="text-white">Hints</h4>
            <p class="text-muted"><span class="badge badge-info">Hint:</span> This is a Rubik's cube</p>
            <p class="text-muted"><span class="badge badge-info">Hint:</span> Try the arrow keys to spin</p>
          </div>
  ...
  <main role="main">
    ...
    <section class="jumbotron text-center">
      <div class="container">
        ...
        <p class="lead text-muted">This is a re-creation of the virtual world made by James Halliday.
          <br> Look for clues in the text and find the easter egg to get the prize.
          <br> Your cursor will tell you if you are on the egg.
        </p>
        <h6><strong>Rules:</strong></h6>
        <ol>
          <li>Don't leave the page.</li>
          <li style="font-size : 125%; font-weight : bold;">HAVE FUN</li>
        </ol>
      </div>
    </section>
    ...
    <div class="album py-5 bg-light">
      <div class="container">
        ...
        <div class="card-deck">
          ...
          <div id="shoto" class="card mb-4 box-shadow face white">
          ...
          <div class="card mb-4 box-shadow face white">
            ...
            <div class="card-body">
              <p class="card-text main-w">
                1. In the year 2045, the world had run out of natural resources and most people were in extreme poverty. The OASIS is a virtual
                world made by James Halliday. It is made up of 27 sectors in the arrangement of a rubik's cube. The first
                sector is where new avatars spawn. Everyone in the world escapes their poverty by going into the OASIS where
        ...
        <div class="card-deck">
          ...
          <div class="card mb-4 box-shadow face white">
            <div class="card-header">Unknown / Ogden Morrow</div>
            <div class="card-body">
              <p class="card-text">
